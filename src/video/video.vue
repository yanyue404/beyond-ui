<template>
  <div class="i-video" ref="videocon">
    <video
      ref="video"
      class="i-videoplayer"
      :muted="options.muted"
    ...
    <!-- 错误弹窗 -->
    <div class="i-video-error" v-show="state.isError">
  ...
  methods: {
    ...
    fullScreen() {
      if (!this.state.fullScreen) {
        ...
        // 再次点击时调用 document.webkitCancelFullScreen() 退出全屏
