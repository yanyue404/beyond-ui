<template>
  <demo-section>
    ...
    <demo-block title="通知类型">
      <cell :showIcon="true" :isLink="true" @click.native="notify2('通知内容')">
        <span slot="title">
          <label>主要通知</label>
        </span>
      </cell>
      <cell :showIcon="true" :isLink="true" @click.native="notify3('成功通知')">
        <span slot="title">
          <label>成功通知</label>
        </span>
      </cell>
      <cell :showIcon="true" :isLink="true" @click.native="notify4('危险通知')">
        <span slot="title">
          <label>危险通知</label>
        </span>
      </cell>
      <cell :showIcon="true" :isLink="true" @click.native="notify5('警告通知')">
        <span slot="title">
          <label>警告通知</label>
        </span>
      </cell>
    ...
    <demo-block title="修改默认配置">
      ...
      <cell :showIcon="true" :isLink="true" @click.native="resetDefaultOptions">
        <span slot="title">
